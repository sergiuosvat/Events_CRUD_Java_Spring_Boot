    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.POST, "/eventCategories/create").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/tags/create").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/events/create").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/events/delete").hasAnyAuthority("ADMIN", "USER");
